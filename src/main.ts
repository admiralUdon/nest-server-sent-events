...
async function bootstrap() {
    ...
    if (process.env.SWAGGER_ENABLED === "true") {
        ...
        SwaggerModule.setup(process.env.SERVER_CONTEXT ? (process.env.SERVER_CONTEXT + '/swagger') : 'swagger', app, document);
        Logger.log(`Swagger configured on http://localhost:3000/swagger`, "MainApplication");
    }
